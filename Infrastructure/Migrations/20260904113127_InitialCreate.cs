    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScientificSources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MuscleGroup = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    TargetMuscle = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    SecondaryMuscles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Equipment = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ...
                    SafetyTips = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecommendedSetsReps = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ScienceNote = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Selector = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerationNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackDifficulty = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    FeedbackNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutHistory_WorkoutPlans_WorkoutPlanId",
                        column: x => x.WorkoutPlanId,
                        principalTable: "WorkoutPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "decimal(7,2)", precision: 7, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetCompletions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SetCompletions_ExerciseSets_ExerciseSetId",
                        column: x => x.ExerciseSetId,
                        principalTable: "ExerciseSets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SetCompletions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_Selector",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SetCompletions_ExerciseSetId",
                table: "SetCompletions",
                column: "ExerciseSetId");

            migrationBuilder.CreateIndex(
                name: "IX_SetCompletions_UserId_ExerciseSetId",
                table: "SetCompletions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutHistory_UserId_WorkoutId_CompletedDate",
                table: "WorkoutHistory",
                columns: new[] { "UserId", "WorkoutId", "CompletedDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutHistory_WorkoutPlanId",
                table: "WorkoutHistory",
